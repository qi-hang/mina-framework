...
//        List<RankRecord> rankData = new ArrayList<>();
//        ShuaDaoRankRecord r=new ShuaDaoRankRecord();
//        r.setName("adfsdf");
//        rankData.add(r);
//
//        String data = JsonUtils.object2String(rankData, new TypeReference<List<RankRecord>>(){});
        System.out.println("?????");
    }
